...
from src.red_black_tree import RedBlackTree, Node, BLACK, RED, NIL
...
class RbTreeTests(unittest.TestCase):
    ...
    def test_recoloring_only(self):
        ...
        """
        tree = RedBlackTree()
        root = Node(key=10, color=BLACK, parent=None)
        # LEFT SUBTREE
        node_m10 = Node(key=-10, color=RED, parent=root) #OK
        node_6 = Node(key=6, color=BLACK, parent=node_m10) #OK
        node_8 = Node(key=8, color=RED, parent=node_6, left=NIL_LEAF, right=NIL_LEAF) #OK
        node_2 = Node(key=2, color=RED, parent=node_6, left=NIL_LEAF, right=NIL_LEAF) #OK
        node_6.left = node_2 #OK
        node_6.right = node_8 #OK
        node_m20 = Node(key=-20, color=BLACK, parent=node_m10, left=NIL_LEAF, right=NIL_LEAF) #OK
        node_m10.left = node_m20 #OK
        node_m10.right = node_6 #OK

        # RIGHT SUBTREE
        node_20 = Node(key=20, color=RED, parent=root) #OK
        node_15 = Node(key=15, color=BLACK, parent=node_20, left=NIL_LEAF, right=NIL_LEAF) #OK
   ...
   --SECOND RECOLOR-->    -20B      6R     15B     25B
    ...
    def test_recoloring_two(self):
        rb_tree = RedBlackTree()
        root = Node(key=10, color=BLACK, parent=None, left=NIL_LEAF, right=NIL_LEAF)
        # left subtree
        node_m10 = Node(key=-10, color=RED, parent=root, left=NIL_LEAF, right=NIL_LEAF)
        node_m20 = Node(key=-20, color=BLACK, parent=node_m10, left=NIL_LEAF, right=NIL_LEAF)
        node_6 = Node(key=6, color=BLACK, parent=node_m10, left=NIL_LEAF, right=NIL_LEAF)
        node_m10.left = node_m20
        node_m10.right = node_6

        # right subtree
        node_20 = Node(key=20, color=RED, parent=root, left=NIL_LEAF, right=NIL_LEAF)
        node_15 = Node(key=15, color=BLACK, parent=node_20, left=NIL_LEAF, right=NIL_LEAF)
        node_25 = Node(key=25, color=BLACK, parent=node_20, left=NIL_LEAF, right=NIL_LEAF)
        node_20.left = node_15
        node_20.right = node_25
        node_12 = Node(key=12, color=RED, parent=node_15, left=NIL_LEAF, right=NIL_LEAF)
        node_17 = Node(key=17, color=RED, parent=node_15, left=NIL_LEAF, right=NIL_LEAF)
    ...
    def test_right_rotation(self):
        ...
        # LEFT SUBTREE
        node_m10 = Node(key=-10, color=BLACK, parent=root, left=NIL_LEAF, right=NIL_LEAF)
        node_7 = Node(key=7, color=RED, parent=node_m10, left=NIL_LEAF, right=NIL_LEAF)
        node_m10.right = node_7

        # RIGHT SUBTREE
        node_20 = Node(key=20, color=BLACK, parent=root, left=NIL_LEAF, right=NIL_LEAF)
        node_15 = Node(key=15, color=RED, parent=node_20, left=NIL_LEAF, right=NIL_LEAF)
        node_20.left = node_15
    ...
    def test_left_rotation_no_sibling(self):
        ...
        root = Node(key=10, color=BLACK, parent=None, left=NIL_LEAF, right=NIL_LEAF)
        # LEFT SUBTREE
        node_7 = Node(key=7, color=BLACK, parent=root, left=NIL_LEAF, right=NIL_LEAF)
        node_8 = Node(key=8, color=RED, parent=node_7, left=NIL_LEAF, right=NIL_LEAF)
        node_7.right = node_8

        # RIGHT SUBTREE
        rightest = Node(key=20, color=BLACK, parent=root, left=NIL_LEAF, right=NIL_LEAF)
        root.left = node_7
        root.right = rightest
    ...
    def test_right_rotation_no_sibling_left_subtree(self):
        ...
        # LEFT SUBTREE
        node_m10 = Node(key=-10, color=BLACK, parent=root, left=NIL_LEAF, right=NIL_LEAF)
        node_m11 = Node(key=-11, color=RED, parent=node_m10, left=NIL_LEAF, right=NIL_LEAF)
    ...
    def test_right_left_rotation_no_sibling(self):
        ...
        root = Node(key=10, color=BLACK, parent=None, left=NIL_LEAF, right=NIL_LEAF)
        # LEFT PART
        nodem10 = Node(key=-10, color=BLACK, parent=root, left=NIL_LEAF, right=NIL_LEAF)
        node_7 = Node(key=7, color=RED, parent=nodem10, left=NIL_LEAF, right=NIL_LEAF)
    ...
    def test_recolor_lr(self):
        ...
        node_6 = Node(key=6, color=BLACK, parent=node_m10, left=NIL_LEAF, right=NIL_LEAF)
        node_m10.right = node_6
        node_1 = Node(key=1, color=RED, parent=node_6, left=NIL_LEAF, right=NIL_LEAF)
        node_6.left = node_1
        node_9 = Node(key=9, color=RED, parent=node_6, left=NIL_LEAF, right=NIL_LEAF)
        node_6.right = node_9
        ...
        node_15 = Node(key=15, color=RED, parent=node_20, left=NIL_LEAF, right=NIL_LEAF)
        node_20.left = node_15
        node_30 = Node(key=30, color=RED, parent=node_20, left=NIL_LEAF, right=NIL_LEAF)
    ...
    def test_right_left_rotation_after_recolor(self):
        ...
        # left subtree
        node_5 = Node(key=5, color=BLACK, parent=root, left=NIL_LEAF, right=NIL_LEAF)
    ...
    def test_right_rotation_after_recolor(self):
        ...
        node_m10.left = node_m20
        node_m10.right = node_6
        node_m21 = Node(key=-21, color=RED, parent=node_m20, left=NIL_LEAF, right=NIL_LEAF)
        node_m19 = Node(key=-19, color=RED, parent=node_m20, left=NIL_LEAF, right=NIL_LEAF)
        node_m20.left = node_m21
        node_m20.right = node_m19
        # right subtree
        node_20 = Node(key=20, color=BLACK, parent=root, left=NIL_LEAF, right=NIL_LEAF)
        node_15 = Node(key=15, color=RED, parent=node_20, left=NIL_LEAF, right=NIL_LEAF)
        node_25 = Node(key=25, color=RED, parent=node_20, left=NIL_LEAF, right=NIL_LEAF)
        node_20.left = node_15
        node_20.right = node_25
 ...
 Add-> -22R                                                        22R
    ...
    def test_deletion_root(self):
        rb_tree = RedBlackTree()
        root = Node(key=5, color=BLACK, parent=None, left=NIL_LEAF, right=NIL_LEAF)
        left_child = Node(key=3, color=RED, parent=root, left=NIL_LEAF, right=NIL_LEAF)
        right_child = Node(key=8, color=RED, parent=root, left=NIL_LEAF, right=NIL_LEAF)
    ...
    def test_delete_single_child(self):
        rb_tree = RedBlackTree()
        root = Node(key=5, color=BLACK, parent=None, left=NIL_LEAF, right=NIL_LEAF)
        left_child = Node(key=1, color=RED, parent=root, left=NIL_LEAF, right=NIL_LEAF)
        right_child = Node(key=6, color=RED, parent=root, left=NIL_LEAF, right=NIL_LEAF)
        root.left = left_child
        root.right = right_child
        rb_tree.root = root
        rb_tree.remove(6)
    ...
    def test_delete_single_deep_child(self):
        rb_tree = RedBlackTree()
        root = Node(key=20, color=BLACK, parent=None, left=NIL_LEAF, right=NIL_LEAF)
        # left subtree
        node_10 = Node(key=10, color=BLACK, parent=None, left=NIL_LEAF, right=NIL_LEAF)
        node_5 = Node(key=5, color=RED, parent=node_10, left=NIL_LEAF, right=NIL_LEAF)
        node_15 = Node(key=15, color=RED, parent=node_10, left=NIL_LEAF, right=NIL_LEAF)
        node_10.left = node_5
        node_10.right = node_15
        # right subtree
        node_38 = Node(key=38, color=RED, parent=root, left=NIL_LEAF, right=NIL_LEAF)
        node_28 = Node(key=28, color=BLACK, parent=node_38, left=NIL_LEAF, right=NIL_LEAF)
        node_48 = Node(key=48, color=BLACK, parent=node_38, left=NIL_LEAF, right=NIL_LEAF)
        node_38.left = node_28
        node_38.right = node_48
        # node_28 subtree
        node_23 = Node(key=23, color=RED, parent=node_28, left=NIL_LEAF, right=NIL_LEAF)
        node_29 = Node(key=29, color=RED, parent=node_28, left=NIL_LEAF, right=NIL_LEAF)
        node_28.left = node_23
        node_28.right = node_29
        # node 48 subtree
        node_41 = Node(key=41, color=RED, parent=node_48, left=NIL_LEAF, right=NIL_LEAF)
        node_49 = Node(key=49, color=RED, parent=node_48, left=NIL_LEAF, right=NIL_LEAF)
    ...
    def test_deletion_red_node_red_successor_no_children(self):
        ...
        root = Node(key=10, color=BLACK, parent=None, left=NIL_LEAF, right=NIL_LEAF)
        # Left subtree
        node_5 = Node(key=5, color=RED, parent=root, left=NIL_LEAF, right=NIL_LEAF)
        node_m5 = Node(key=-5, color=BLACK, parent=root, left=NIL_LEAF, right=NIL_LEAF)
        node_7 = Node(key=7, color=BLACK, parent=node_5, left=NIL_LEAF, right=NIL_LEAF)
        node_5.left = node_m5
        node_5.right = node_7

        # right subtree
        node_35 = Node(key=35, color=RED, parent=root, left=NIL_LEAF, right=NIL_LEAF)
        node_20 = Node(key=20, color=BLACK, parent=node_35, left=NIL_LEAF, right=NIL_LEAF)
        node_38 = Node(key=38, color=BLACK, parent=node_35, left=NIL_LEAF, right=NIL_LEAF)
        node_35.left = node_20
        node_35.right = node_38
        node_36 = Node(key=36, color=RED, parent=node_38, left=NIL_LEAF, right=NIL_LEAF)
    ...
    def test_mirror_deletion_red_node_red_successor_no_children(self):
        ...
        node_5.left = node_m5
        node_5.right = node_7
        node_6 = Node(key=6, color=RED, parent=node_7, left=NIL_LEAF, right=NIL_LEAF)
        node_7.left = node_6
    ...
    def test_deletion_black_node_black_successor_right_red_child(self):
        ...
        # left subtree
        node_5 = Node(key=5, color=BLACK, parent=root, left=NIL_LEAF, right=NIL_LEAF)
        node_m5 = Node(key=-5, color=BLACK, parent=node_5, left=NIL_LEAF, right=NIL_LEAF)
        node_7 = Node(key=7, color=BLACK, parent=node_5, left=NIL_LEAF, right=NIL_LEAF)
        node_5.left = node_m5
        node_5.right = node_7
        # right subtree
        node_30 = Node(key=30, color=BLACK, parent=root, left=NIL_LEAF, right=NIL_LEAF)
        node_20 = Node(key=20, color=BLACK, parent=node_30, left=NIL_LEAF, right=NIL_LEAF)
        node_38 = Node(key=38, color=RED, parent=node_30, left=NIL_LEAF, right=NIL_LEAF)
        node_30.left = node_20
        node_30.right = node_38
        # 38 subtree
        node_32 = Node(key=32, color=BLACK, parent=node_38, left=NIL_LEAF, right=NIL_LEAF)
        node_41 = Node(key=41, color=BLACK, parent=node_38, left=NIL_LEAF, right=NIL_LEAF)
        node_38.left = node_32
        node_38.right = node_41
        node_35 = Node(key=35, color=RED, parent=node_32, left=NIL_LEAF, right=NIL_LEAF)
    ...
    def test_deletion_black_node_black_successor_no_child_case_4(self):
        ...
        node_m10 = Node(key=-10, color=BLACK, parent=root, left=NIL_LEAF, right=NIL_LEAF)
        # right subtree
        node_30 = Node(key=30, color=RED, parent=root, left=NIL_LEAF, right=NIL_LEAF)
        node_20 = Node(key=20, color=BLACK, parent=node_30, left=NIL_LEAF, right=NIL_LEAF)
        node_38 = Node(key=38, color=BLACK, parent=node_30, left=NIL_LEAF, right=NIL_LEAF)
        node_30.left = node_20
        node_30.right = node_38
    ...
    def test_deletion_black_node_no_successor_case_6(self):
        ...
        # right subtree
        node_30 = Node(key=30, color=BLACK, parent=root, left=NIL_LEAF, right=NIL_LEAF)
        node_25 = Node(key=25, color=RED, parent=node_30, left=NIL_LEAF, right=NIL_LEAF)
        node_40 = Node(key=40, color=RED, parent=node_30, left=NIL_LEAF, right=NIL_LEAF)
    ...
    def test_mirror_deletion_black_node_no_successor_case_6(self):
        rb_tree = RedBlackTree()
        root = Node(key=10, color=BLACK, parent=None, left=NIL_LEAF, right=NIL_LEAF)
        node_12 = Node(key=12, color=BLACK, parent=root, left=NIL_LEAF, right=NIL_LEAF)
        node_5 = Node(key=5, color=BLACK, parent=root, left=NIL_LEAF, right=NIL_LEAF)
        node_1 = Node(key=1, color=RED, parent=node_5, left=NIL_LEAF, right=NIL_LEAF)
        node_7 = Node(key=7, color=RED, parent=node_5, left=NIL_LEAF, right=NIL_LEAF)
        node_5.left = node_1
        node_5.right = node_7
        root.left = node_5
        root.right = node_12
    ...
    def test_deletion_black_node_no_successor_case_3_then_5_then_6(self):
        ...
        root = Node(key=10, color=BLACK, parent=None, left=NIL_LEAF, right=NIL_LEAF)
        # left subtree
        node_m30 = Node(key=-30, color=BLACK, parent=root, left=NIL_LEAF, right=NIL_LEAF)
        node_m40 = Node(key=-40, color=BLACK, parent=node_m30, left=NIL_LEAF, right=NIL_LEAF)
        node_m20 = Node(key=-20, color=BLACK, parent=node_m30, left=NIL_LEAF, right=NIL_LEAF)
        node_m30.left = node_m40
        node_m30.right = node_m20
        # right subtree
        node_50 = Node(key=50, color=BLACK, parent=root, left=NIL_LEAF, right=NIL_LEAF)
        node_30 = Node(key=30, color=RED, parent=node_50, left=NIL_LEAF, right=NIL_LEAF)
        node_70 = Node(key=70, color=BLACK, parent=node_50, left=NIL_LEAF, right=NIL_LEAF)
        node_50.left = node_30
        node_50.right = node_70
        node_15 = Node(key=15, color=BLACK, parent=node_30, left=NIL_LEAF, right=NIL_LEAF)
        node_40 = Node(key=40, color=BLACK, parent=node_30, left=NIL_LEAF, right=NIL_LEAF)
  ...
  REMOVE-->|-40B|  -20B   30R   70B     --CASE 3--> REMOVED  -20R   30R   70B
    ...
    def test_mirror_deletion_black_node_no_successor_case_3_then_5_then_6(self):
        ...
        """
        rb_tree = RedBlackTree()
        root = Node(key=50, color=BLACK, parent=None, left=NIL_LEAF, right=NIL_LEAF)
        # left subtree
        node_30 = Node(key=30, color=BLACK, parent=root, left=NIL_LEAF, right=NIL_LEAF)
        node_20 = Node(key=20, color=BLACK, parent=node_30, left=NIL_LEAF, right=NIL_LEAF)
        node_35 = Node(key=35, color=RED, parent=node_30, left=NIL_LEAF, right=NIL_LEAF)
        node_30.left = node_20
        node_30.right = node_35
        node_34 = Node(key=34, color=BLACK, parent=node_35, left=NIL_LEAF, right=NIL_LEAF)
        node_37 = Node(key=37, color=BLACK, parent=node_35, left=NIL_LEAF, right=NIL_LEAF)
        node_35.left = node_34
        node_35.right = node_37
        # right subtree
        node_80 = Node(key=80, color=BLACK, parent=root, left=NIL_LEAF, right=NIL_LEAF)
        node_70 = Node(key=70, color=BLACK, parent=node_80, left=NIL_LEAF, right=NIL_LEAF)
        node_90 = Node(key=90, color=BLACK, parent=node_80, left=NIL_LEAF, right=NIL_LEAF)
    ...
    def test_deletion_black_node_successor_case_2_then_4(self):
        ...
        node_m10 = Node(key=-10, color=BLACK, parent=root, left=NIL_LEAF, right=NIL_LEAF)
        node_m20 = Node(key=-20, color=BLACK, parent=node_m10, left=NIL_LEAF, right=NIL_LEAF)
        node_m5 = Node(key=-5, color=BLACK, parent=node_m10, left=NIL_LEAF, right=NIL_LEAF)
        node_m10.left = node_m20
        node_m10.right = node_m5
        # right subtree
        node_40 = Node(key=40, color=BLACK, parent=root, left=NIL_LEAF, right=NIL_LEAF)
        node_20 = Node(key=20, color=BLACK, parent=node_40, left=NIL_LEAF, right=NIL_LEAF)
        node_60 = Node(key=60, color=RED, parent=node_40, left=NIL_LEAF, right=NIL_LEAF)
        node_40.left = node_20
        node_40.right = node_60
        node_50 = Node(key=50, color=BLACK, parent=node_60, left=NIL_LEAF, right=NIL_LEAF)
        node_80 = Node(key=80, color=BLACK, parent=node_60, left=NIL_LEAF, right=NIL_LEAF)
  ...
  REMOVE--->    ___10B___           parent is black             ___20B___
    ...
    def test_mirror_deletion_black_node_successor_case_2_then_4(self):
        ...
        root = Node(key=20, color=BLACK, parent=None, left=NIL_LEAF, right=NIL_LEAF)
        # left subtree
        node_10 = Node(key=10, color=BLACK, parent=root, left=NIL_LEAF, right=NIL_LEAF)
        node_8 = Node(key=8, color=RED, parent=node_10, left=NIL_LEAF, right=NIL_LEAF)
        node_15 = Node(key=15, color=BLACK, parent=node_10, left=NIL_LEAF, right=NIL_LEAF)
        node_10.left = node_8
        node_10.right = node_15
        node_6 = Node(key=6, color=BLACK, parent=node_8, left=NIL_LEAF, right=NIL_LEAF)
        node_9 = Node(key=9, color=BLACK, parent=node_8, left=NIL_LEAF, right=NIL_LEAF)
        node_8.left = node_6
        node_8.right = node_9
        # right subtree
        node_30 = Node(key=30, color=BLACK, parent=root, left=NIL_LEAF, right=NIL_LEAF)
        node_25 = Node(key=25, color=BLACK, parent=node_30, left=NIL_LEAF, right=NIL_LEAF)
        node_35 = Node(key=35, color=BLACK, parent=node_30, left=NIL_LEAF, right=NIL_LEAF)
        node_30.left = node_25
        node_30.right = node_35
